...
class ConnectController extends AbstractController
{
    ...
    {
        $results = $this->articleExplorer->fetchAll("SELECT * FROM settings_location WHERE status = 10 AND client_id = '" . $client_uuid . "'");
        $collection = new ArrayCollection();
    ...
    public function calculatePriceForArticlesFassbender(array $article_id_array, int $rental_start, int $rental_end, bool $calculate_deals_and_discounts = false, $rentsoft_customer_id = null)
    {
        ...
        foreach ($article_id_array as $article_id) {
            ...
            $rentalEndCalculation = mktime($endSplittedHourMinute[0], $endSplittedHourMinute[1], 59, $endSplitted[1], $endSplitted[0], $endSplitted[2]);
